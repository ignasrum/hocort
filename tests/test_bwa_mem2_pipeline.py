...
def test_bwa_mem2_pipeline_seq2_no_out2():
    returncode = BWA_MEM2().run(idx, seq1, out1, seq2=seq2)
    assert returncode == 0

def test_bwa_mem2_pipeline_noseq2_out2():
