...
class Pipeline(ABC):
    ...
    def filter(self, query_names, seq1, out1, seq2=None, out2=None, include='f'):
        ...
        returncode1, stdout1, stderr1 = FastQ.filter_by_id(seq1, out1, seq_ids_output, include=include)

        if seq2 is not None:
            self.logger.info('Removing reads from input fastq file 2')
            returncode2, stdout2, stderr2 = FastQ.filter_by_id(seq2, out2, seq_ids_output, include=include)
